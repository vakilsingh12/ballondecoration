    ...
    <footer className="text-gray-600 body-font bg-gray-100" id="contact">
      <div className="container py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="md:w-1/4 flex-shrink-0  md:mx-10  mx-auto  md:text-left">
          ...
          >
            <Image src={'/logo.png'} width={70} height={70} alt={"logo"} className="rounded-full md:ml-2 ml-4 mr-4"/>
        ...
        <form>
          <div className="form-group mb-4">
            ...
            ease-in-out
            m-0
            focus:text-gray-700 focus:bg-white focus:border-fuchsia-600 focus:outline-none" id="exampleInput7"
              placeholder="Name"/>
          </div>
          <div className="form-group mb-4">
            ...
            ease-in-out
            m-0
            focus:text-gray-700 focus:bg-white focus:border-fuchsia-600 focus:outline-none" id="exampleInput8"
